...
export const platformNodes = [
  { label: 'Revenue Operations', copy: 'Managed revenue-cycle execution from charge capture through final reimbursement, connecting claim quality, payment posting, denial prevention, payer follow-up, and A/R recovery.' },
  { label: 'Credentialing', copy: 'Revenue readiness across provider enrollment, payer participation, effective dates, revalidation, location rosters, and timely escalation.' },
  { label: 'Practice Operations', copy: 'Practice-wide workflow ownership, performance controls, staffing capacity, escalation, and leadership visibility as organizations grow.' },
  { label: 'Technology', copy: 'Healthcare data architecture, EHR/PM workflow alignment, interoperability planning, access governance, and reliable source data.' },
  { label: 'Automation', copy: 'Turn stable, repetitive administrative tasks into monitored workflows with human review and measurable operating impact.' },
  { label: 'Analytics', copy: 'Connect financial and operational data into decision-grade revenue intelligence, payer analytics, reconciled KPIs, and accountable action.' },
  { label: 'DIRT Intelligence', copy: 'DIRT — Data Intelligence for Revenue Transformation — connects fragmented revenue signals, identifies financial exposure, explains root causes, and prioritizes human-owned action.' },
];
...
export const solutionPages = [
  {
    ...
    summary: 'Expose hidden revenue leakage across eligibility, authorizations, claim quality, payer reimbursement, underpayments, takebacks, denials, and aging A/R.',
  ...
  },
  {
    slug: 'aging-ar',
    title: 'Aging A/R',
    summary: 'Turn aging A/R into financial triage: separate collectible balances, payer delays, rework, and recovery opportunities by value and urgency.',
  ...
  },
  {
    slug: 'denials',
    title: 'Denials',
    summary: 'Move beyond denial counts to payer-specific root causes, denial prevention, recoverable value, and accountable corrective action.',
  ...
  },
  {
    ...
    summary: 'Protect revenue readiness by connecting provider enrollment, payer participation, effective dates, revalidation, and location rosters.',
  ...
  },
  {
    ...
    summary: 'Bring fragmented EHR, PM, clearinghouse, payer, and finance data into a reliable view of revenue performance and next actions.',
  ...
  },
  {
    ...
    summary: 'Expand providers, sites, and services with clearer revenue controls, credentialing readiness, and leadership visibility.',
...
export const servicePages = [
  {
    ...
    summary: 'Managed RCM connected to revenue intelligence: strengthen clean-claim workflows, denial prevention, reimbursement, cash visibility, and A/R recovery.',
  ...
  },
  {
    ...
    summary: 'Claim preparation, submission, rejection repair, and payer follow-up connected to the full revenue journey.',
  ...
  },
  {
    ...
    family: 'Revenue Operations',
    title: 'A/R Recovery',
    summary: 'Financially prioritized A/R recovery: focus payer follow-up and appeals on value, age, status, and likely recovery path.',
  ...
  },
  {
    ...
    summary: 'Recover denied revenue and trace recurring payer and workflow patterns upstream to reduce preventable rework.',
  ...
  },
  {
    ...
    title: 'Credentialing',
    summary: 'Credentialing as revenue infrastructure: provider enrollment, payer participation, effective dates, revalidation, and roster intelligence.',
  ...
  },
  {
    ...
    family: 'Technology',
    title: 'Healthcare IT',
    summary: 'Make healthcare systems work together through EHR/PM alignment, data architecture, integration planning, access governance, and source-data reliability.',
  ...
  },
  {
    ...
    summary: 'Connect decision intelligence to accountable, monitored workflows; automate stable administrative work where it adds measurable value.',
  ...
  },
  {
    ...
    summary: 'Revenue intelligence that reconciles data, reveals payer and denial patterns, identifies exposure, and turns metrics into decisions.',
...
export const pricingModels = [
  ...
  { name: 'DIRT / Data Intelligence', price: '$1,500-$2,500/month', bestFor: 'Healthcare organizations seeking connected financial visibility, payer and denial intelligence, and prioritized action beyond isolated dashboards.', includes: ['Leakage analysis', 'Denial intelligence', 'A/R prioritization', 'PracticeOps signals'], cta: 'Explore DIRT', href: '/technology/dirt/' },
...
export const diagnosticFaq = [
  ...
  ['Is ROOT only a diagnostic company?', 'No. ROOT is a healthcare revenue intelligence and operating partner spanning managed RCM, credentialing, practice operations, technology, and DIRT. The Diagnostic is an optional fixed-fee entry engagement.'],
